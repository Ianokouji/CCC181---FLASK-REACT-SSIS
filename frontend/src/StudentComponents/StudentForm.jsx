...
function StundentForm ({studentToUpdate = {}, updateCallBack, closeStudentForm,}) {
    ...
    const updateStudent = async () => {
        try {
            if(!student_id || !firstname || !lastname || !year_level || !gender || !program_code){
            ...
            console.log("Program updated successfully: ",response.config.data);
            setStudentId("");
            setFirstName("");
            setLastName("")
            setYearLevel("");
            ...
            console.error("Error in updating Student",error?.response?.data?.message);
        }
    };

    const addStudent = async () => {
        try {
            console.log({ student_id, firstname, lastname, year_level, gender, program_code });
            if(!student_id || !firstname || !lastname || !year_level || !gender || !program_code){
                alert("Please fill in all fields");
                return;
            }
            ...
            console.log("Student added successfully",response.config.data);
            setStudentId("");
            setFirstName("");
            setLastName("")
            setYearLevel("");
            ...
            alert(error?.response?.data?.message);
            console.error("Error in adding Student",error?.response?.data?.message);
        }
    };
